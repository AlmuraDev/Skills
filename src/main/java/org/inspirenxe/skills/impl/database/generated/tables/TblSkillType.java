...
public class TblSkillType extends TableImpl<TblSkillTypeRecord> {
     ...
     */
    public final TableField<TblSkillTypeRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>tbl_skill_type.created</code>.
     */
    public final TableField<TblSkillTypeRecord, Timestamp> CREATED = createField("created", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
